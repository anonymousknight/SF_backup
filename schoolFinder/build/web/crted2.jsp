<html>
    ...
    <body>
        ...
        <div class="con-3">
            ...
            <input type="text" placeholder="Address 3" name="add3" value="" class="c2"/><br>
            <input type="text" placeholder="Pincode" name="pcode" value="" class="c2"/><br>
        ...
        <div class="con-5">
            ...
            <h3>FACILITIES</h3>
            <div class="fac">
                <input type="checkbox" name="checkbox1" class="check1" value=YES/>
            ...
            <input type="checkbox" name="MEDICAL" value="ON" class="check3" />SPORTS
             ...
             <br>
             <div><h3 class="h4">ABOUT</h3>
                <h3><textarea rows="5" cols="10"name=ab1 class="t1">about school</textarea>
                 <textarea rows="5" cols="10"name=ab2 class="t2">about school</textarea><br>
                  <textarea rows="5" cols="10"name=ab3 class="t1">about school</textarea>
                  <textarea rows="5" cols="10"name=ab4 class="t2">about school</textarea>
             </div>
