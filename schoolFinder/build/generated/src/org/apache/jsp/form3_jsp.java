...
String c=request.getParameter("f3");
...
String h=request.getParameter("map");
          try
        {
          ...
          Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/check2", "root", "");
          
          Statement st = con.createStatement();
          
          st.executeUpdate("insert into login(NAME,BOARD,MEDIUM,CODE,ADD1,ADD2,EMAIL and LOC) values ('"+a+"','"+b+"','"+c+"','"+d+"','"+i+"','"+f+"','"+g+"','"+h+"')");
